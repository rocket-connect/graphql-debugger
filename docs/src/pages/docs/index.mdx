...
Mostly developers interact with GraphQL Debugger UI and Client SDK's. [The Open Telemetry Collector](/docs/components/collector) is a component that collects data from your GraphQL Server and sends it to the GraphQL Debugger Backend.
