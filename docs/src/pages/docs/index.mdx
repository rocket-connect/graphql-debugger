...
For the most part you will mostly interact with GraphQL Debugger UI and Client SDK's. [The Open Telemetry Collector](/docs/components/collector) is a component that collects data from your GraphQL Server and sends it to the GraphQL Debugger Backend.

## Running debugger locally

To get started run the [GraphQL Debugger CLI](/docs/packages/cli). This will start the Collector, Backend and UI for you. You can install and run it with one command:
