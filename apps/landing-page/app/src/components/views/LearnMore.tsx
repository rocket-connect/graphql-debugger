...
export function LearnMore() {
  return (
    <div className="bg-graphiql-light text-graphiql-dark">
      <Container>
        <div className="flex flex-col md:flex-row gap-20 py-20 w-full lg:w-5/6 lg:mx-auto">
          <div className="bg-graphiql-medium w-5/6 h-64 rounded rounded-3xl p-3 mt-auto mx-auto">
            <iframe
