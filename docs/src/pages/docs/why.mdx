...
Given the fact that GraphQL is strongly typed, we can leverage the schema to provide a better debugging experience. Our goal with debugger is to continue to leverage the schema alongside telemetry to provide a better debugging experience.
